        ...
        <Layout>
            <div className="main">
                <div className="dashboard-content pt-3"> 
                    <h2 className="border-bottom pb-1 fs-4">{ (retrievedUser?.data?.first_name)?.slice(0,1)?.toUpperCase()+(retrievedUser?.data?.first_name)?.slice(1)?.toLowerCase() + ' ' + (retrievedUser?.data?.last_name)?.slice(0,1)?.toUpperCase()+(retrievedUser?.data?.last_name)?.slice(1)?.toLowerCase() }</h2> 
