...
export default function Edit() { 
    ...
    const { deal, updateDeal } = useDeal(params?.id); 
    // console.log(deal); 
                                ...
                                <div className="image row g-2 ">
                                    <div className="position-relative"> 
                                        ...
                                        <div onClick={handleImageClick} className="cursor-pointer border-radius-15 d-flex justify-content-center align-items-center" style={{ width: '200px', height: '200px', backgroundColor: '#f0f0f0' }}>
                                            { (image || deal?.data?.image_path?.url) ? (
                                                <img src={image || deal?.data?.image_path?.url} alt="Preview" className="border-radius-15" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                            ) : (
                                                <span>
