                ...
                <div className="main">
                    ...
                    <div className="">
                        <section className="introduction">
                            <h3 className="fs-5">Introduction</h3>
                        ...
                        <section className="use-of-the-website">
                            <h3 className="fs-5">Use of the Website</h3>
                        ...
                        <section className="product-information-and-availability">
                            <h3 className="fs-5">Product Information and Availability</h3>
                        ...
                        <section className="orders-and-payments">
                            <h3 className="fs-5">Orders and Payments</h3>
                        ...
                        <section className="shipping-and-delivery">
                            <h3 className="fs-5">Shipping and Delivery</h3>
                        ...
                        <section className="returns-and-refunds">
                            <h3 className="fs-5">Returns and Refunds</h3>
                        ...
                        <section className="limitation-of-liability">
                            <h3 className="fs-5">Limitation of Liability</h3>
                        ...
                        <section className="governing-law">
                            <h3 className="fs-5">Governing Law</h3>
