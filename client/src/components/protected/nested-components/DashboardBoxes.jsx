...
export default function DashboardBoxes() { 
    ...
    return (
        <section className="dashboard-boxes d-flex flex-column gap-4">
            <div className={`line line-1 ${((user?.user?.role != 'individual') && 
                ...
                <section className="order-expenditure gap-4">
                    ...
                    <div className="expenditure d-flex justify-content-between p-3 border-radius-25 box-shadow-1">
                        <div className="d-flex flex-column justify-content-between gap-2">
                            ...
                            <span className="fs-4 fw-semibold">${ totalExpenditure?.data ? (totalExpenditure?.data)?.toLocaleString('en') : 0 }</span>
                        </div>
                    </div>
                </section>
