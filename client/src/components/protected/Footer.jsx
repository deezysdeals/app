...
export default function Footer() { 
    return (
        <footer className="footer pt-5 px-3 z-2"> 
            ...
            <div className="d-flex align-items-center justify-content-end flex-wrap row-gap-0 column-gap-1 ps-5 pe-4 pb-1">
                <section className="socials pt-3">
                ...
                <section className="ps-4">
                    <span>&copy;&nbsp;<small>2024. DeezysDeals</small></span>
                </section>
            </div>
        </footer>
    )
