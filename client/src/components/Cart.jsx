        ...
        <section className="cart"> 
            ...
            { cartToggle && 
                <div id="cart-box" className="cart-box card p-2"> 
                    ...
                    { (cartItems?.length > 0) && 
                        <div className={`cart-footer bg-white border rounded ${(!(location?.pathname == route('pay')) && `py-4`)} px-3`}> 
                            { !(location?.pathname == route('pay')) && 
                                <Link 
                                    to={ route('pay') }
            ...
            <div 
                ...
                className="cart-btn cursor-pointer"> 
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-handbag-fill text-white" viewBox="0 0 16 16">
                        <path
